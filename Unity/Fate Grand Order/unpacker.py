...
if __name__ == "__main__":
    ...
    parser.add_argument("--src", default=r"E:\Game_Dataset\com.aniplex.fategrandorder\DEC\ScriptActionEncrypt")
    parser.add_argument("--dst", default=r"E:\Game_Dataset\com.aniplex.fategrandorder\EXP\Story_ENC")
    parser.add_argument("--id", default=True)
    parser.add_argument("--ignore", type=int, default=3, metavar="N")
