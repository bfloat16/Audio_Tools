...
class SilkyMesScript:
    ...
    def __init__(self, mes_name: str, txt_name: str, encoding: str = "", debug: bool = False, verbose: bool = False, hackerman_mode: bool = False):
        """Prms:
...
if __name__ == "__main__":
    silky = SilkyMesScript(r"D:\Fuck_galgame\sc\FK001.MES", r"D:\Fuck_galgame\sc\FK001.txt")
    silky.disassemble()