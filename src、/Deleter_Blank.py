...
def cut_silence(input_file, output_file, silence_threshold=-60, min_silence_len=5000):
...
def process_one(file, input_folder, output_folder, silence_threshold=-60, min_silence_len=5000):
    input_file = file
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder", type=str, default=r"E:\Dataset\東北イタコ_de", help="path to input dir")
    parser.add_argument('--output_folder', type=str, default=r"E:\Dataset\東北イタコ_clean", help='path to output dir')
