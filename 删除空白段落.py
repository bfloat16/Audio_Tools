...
def cut_silence(input_file, output_file, silence_threshold=-60, min_silence_len=300):
...
def process_one(file, input_folder, output_folder, silence_threshold=-60, min_silence_len=300):
    input_file = file
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder", type=str, default="/home/ooppeenn/Desktop/1", help="path to input dir")
    parser.add_argument('--output_folder', type=str, default="/home/ooppeenn/Desktop/2", help='path to output dir')
    parser.add_argument('--num_processes', type=int, default=10, help='set the number of processes')
